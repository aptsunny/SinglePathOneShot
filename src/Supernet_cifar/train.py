...
from utils import accuracy, AvgrageMeter, CrossEntropyLabelSmooth, save_checkpoint, get_lastest_model, get_parameters, shuffle_dif_lr_parameters, fast_dif_lr_parameters, fast_19_lr_parameters, mobile_dif_lr_parameters, count_parameters_in_MB, random_choice, adjust_bn_momentum
...
def get_args():
    ...
    parser.add_argument('--lr-range', type=str, default= "0.01,0.2", help='learning-rate range. default is 0.001,0.2.')
