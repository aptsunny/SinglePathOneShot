...
def get_args():
    ...
    parser.add_argument('--optimizer', type=str, default='SGD', help='optimizer:SGD/Adadelta/Adam   Adagrad/->cpu', )
    ...
    parser.add_argument('--criterion-smooth', default=True, action='store_true')
...
def prepare():
    ...
    for epoch in range(start_epoch, start_epoch + args.epochs):
        ...
        print('Epoch {}, loss/train acc = {:.2f}/{:.2f}, val acc/best acc = {:.2f}/{:.2f},'.format(epoch, loss_output, train_acc, acc, best_acc))
